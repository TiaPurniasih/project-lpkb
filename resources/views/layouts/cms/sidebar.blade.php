@php
    $menuItems = [
        ...
        [
            ...
            'active' => request()->routeIs('cms.manage.permit.*'),
            'expandable' => true,
            'children' => [
                [
                    'label' => 'List Pengajuan Izin',
                    'href' => route('cms.manage.permit'),
                    'active' => request()->routeIs('cms.manage.permit'),
                ],
                [
        ...
        [
            ...
            'href' => route('cms.manage.certificate'),
            'icon' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline>',
        ...
        [
            ...
            'href' => route('cms.manage.users'),
            'icon' => '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>',
            'active' => request()->routeIs('cms.manage.users'),
        ],

    ];

     if(auth()->user()->hasLevel(App\Models\User::ROLE_ADMIN)){
        $menuItems[] = 
        [
            'type' => 'menu-item',
            'label' => 'Manajemen Kanwil',
            'href' => route('cms.manage.kanwil'),
            'icon' => '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path>',
            'active' => request()->routeIs('cms.manage.kanwil'),
        ];
        $menuItems[] = 
        [
            'type' => 'menu-item',
            ...
            'active' => request()->routeIs('cms.setting.*'),
            'expandable' => true,
            'children' => [
                [
                    'label' => 'General',
                    'href' => route('cms.setting'),
                    'active' => request()->routeIs('cms.setting'),
                ],
                [
                    'label' => 'Formulir',
                    'href' => route('cms.setting.forms'),
                    'active' => request()->routeIs('cms.setting.forms'),
                ],
            ],
        ];
    }
...
<aside x-cloak
    ...
    <!-- Logo Section -->
    <div class="border-b p-3 h-[60px]">
        <div class="h-full w-[250px] flex items-center gap-2 ">
            <div class="flex h-6 w-6 items-center justify-center rounded bg-red-500 text-lg font-bold text-white">
                S
            </div>
            <div>
                <h1 class="font-bold text-gray-800">SIOPKB</h1>
                <!-- <p class="text-xs text-gray-500">Pendidikan Keagamaan Buddha</p> -->
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 p-4">
        ...
        @foreach ($menuItems as $item)
            @if($item['type'] =='separator')
                <p class="mb-3 px-3 text-xs text-gray-500 mt-4">{{$item['label']}}</p>
            @else
                @php
