        ...
        <nav x-data="{ selected: '{{request()->path()}}' }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-4">
                    <li>
                        <a href="{{ route(name: 'dashboard') }}" class="menu-item group 
            ...
            <div>
                <h3 class="mb-4 text-xs uppercase leading-[20px] text-gray-400">
                 ...
                 <ul class="flex flex-col gap-4 mb-4">
                    <li>
                        <a href="{{ route( 'manage.users') }}" class="menu-item group 
                               {{ request()->routeIs('manage.users') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" 
                                class="{{ request()->routeIs('manage.users') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}">
