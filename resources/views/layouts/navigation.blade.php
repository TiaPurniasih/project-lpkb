...
<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('cms.dashboard') }}">
            ...
            <h1 class="text-lg text-red-500" :class="sidebarToggle ? 'lg:block' : 'hidden'">SIOPKB</h1>
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <!-- Sidebar Menu -->
        <nav x-data="{ selected: '{{request()->path()}}' }">
            <!-- Menu Group -->
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-4">
                    <li>
                        <a href="{{ route( 'cms.dashboard') }}" class="menu-item group 
                               {{ request()->routeIs('cms.dashboard') ? 'menu-item-active' : 'menu-item-inactive' }}">

                            <svg class="{{ request()->routeIs('cms.dashboard') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                    ...
                    <!-- <li>
                        <a href="{{ route(name: 'template.basic_tables') }}" class="menu-item group 
                               {{ request()->routeIs('template.basic_tables') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg  class="{{ request()->routeIs('template.basic_tables') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[{{ request()->routeIs('template.basic_tables') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive' }}, sidebarToggle ? 'lg:hidden' : '' ]"
             ...
             <div>
                ...
                <ul class="flex flex-col gap-4 mb-4">
                    <li>
                        <a href="{{ route( 'cms.kanwil') }}" class="menu-item group 
                               {{ request()->routeIs('cms.kanwil') ? 'menu-item-active' : 'menu-item-inactive' }}">

                            <svg class="{{ request()->routeIs('cms.kanwil') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V8.99998C3.25 10.2426 4.25736 11.25 5.5 11.25H9C10.2426 11.25 11.25 10.2426 11.25 8.99998V5.5C11.25 4.25736 10.2426 3.25 9 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H9C9.41421 4.75 9.75 5.08579 9.75 5.5V8.99998C9.75 9.41419 9.41421 9.74998 9 9.74998H5.5C5.08579 9.74998 4.75 9.41419 4.75 8.99998V5.5ZM5.5 12.75C4.25736 12.75 3.25 13.7574 3.25 15V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H9C10.2426 20.75 11.25 19.7427 11.25 18.5V15C11.25 13.7574 10.2426 12.75 9 12.75H5.5ZM4.75 15C4.75 14.5858 5.08579 14.25 5.5 14.25H9C9.41421 14.25 9.75 14.5858 9.75 15V18.5C9.75 18.9142 9.41421 19.25 9 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V15ZM12.75 5.5C12.75 4.25736 13.7574 3.25 15 3.25H18.5C19.7426 3.25 20.75 4.25736 20.75 5.5V8.99998C20.75 10.2426 19.7426 11.25 18.5 11.25H15C13.7574 11.25 12.75 10.2426 12.75 8.99998V5.5ZM15 4.75C14.5858 4.75 14.25 5.08579 14.25 5.5V8.99998C14.25 9.41419 14.5858 9.74998 15 9.74998H18.5C18.9142 9.74998 19.25 9.41419 19.25 8.99998V5.5C19.25 5.08579 18.9142 4.75 18.5 4.75H15ZM15 12.75C13.7574 12.75 12.75 13.7574 12.75 15V18.5C12.75 19.7426 13.7574 20.75 15 20.75H18.5C19.7426 20.75 20.75 19.7427 20.75 18.5V15C20.75 13.7574 19.7426 12.75 18.5 12.75H15ZM14.25 15C14.25 14.5858 14.5858 14.25 15 14.25H18.5C18.9142 14.25 19.25 14.5858 19.25 15V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H15C14.5858 19.25 14.25 18.9142 14.25 18.5V15Z"
            ...
            <div>
                ...
                @if ($user->hasLevel(\App\Models\User::ROLE_ADMIN))
                <ul class="flex flex-col gap-4 mb-4">
                    <li>
                        <a href="{{ route( 'cms.manage.users') }}" class="menu-item group 
                               {{ request()->routeIs('cms.manage.users') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" 
                                class="{{ request()->routeIs('cms.manage.users') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}">
                    ...
                    <li>
                        <a href="{{ route( 'cms.manage.kanwil') }}" class="menu-item group 
                               {{ request()->routeIs('cms.manage.kanwil') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" 
                                class="{{ request()->routeIs('cms.manage.kanwil') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}">
                                <path d="M18 21a8 8 0 0 0-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"/>
                            </svg>
                            <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                                Manajemen User Kanwil
                            </span>
                        </a>
                    </li>
                    @if ($user->hasLevel(\App\Models\User::ROLE_SUPERADMIN))
                    <li>
                        <a href="{{ route( 'cms.manage.kanwil') }}" class="menu-item group 
                               {{ request()->routeIs('cms.manage.kanwil') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" 
                                class="{{ request()->routeIs('cms.manage.admin') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}">
                                <path d="M18 21a8 8 0 0 0-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"/>
                            </svg>
                            <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                                Manajemen Kanwil
