    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                class="z-99999 flex h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 "
            ...
            <a href="index.html" class="lg:hidden">
                <h1 class="dark:hidden">{{ __('theme.brand') }}</h1>
                <h1 class="hidden">{{ __('theme') }}</h1>
            </a>
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700" href="#"
                    ...
                    <svg :class="dropdownOpen && 'rotate-180'" class="stroke-gray-500"
                ...
                <div x-show="dropdownOpen"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button
                            ...
                            href="{{ route(name: 'logout') }}"
                            class="block w-full px-4 py-2 text-start text-sm text-gray-700 hover:bg-gray-100 transition duration-150 ease-in-out">
                            <svg class="fill-gray-500 group-hover:fill-gray-700"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
