                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" placeholder="info@gmail.com"
                                    ...
                                    <div>
                                        <button
                                            class="bg-[#ff6b59] shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                                            Daftar
                                        </button>
                                    </div>
                                </div>
