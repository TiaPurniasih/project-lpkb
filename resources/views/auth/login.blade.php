...
@section('contents')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                        ...
                        <div>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        @error('email')
                                            <div class="text-sm font-normal text-error-500 mt-4">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="/reset-password.html"
                                            class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">Lupa sandi?</a>
                                    </div>
                                    <!-- Button -->
                                    <div>
                                        <button
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Belum punya akun?
                                    <a href="/signup.html"
                                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Daftar disini   </a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-[#faeae8] relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    <div class="flex max-w-lg flex-col items-center">
                        <h1 class="text-red-400 text-4xl font-semibold">SIOPKB</h1>
                        <p class="text-center text-gray-900 dark:text-white/60">
                            SISTEM OPERASI PENDIDIKAN KEAGAMAAN BUDHA
                        </p>
                    </div>
                </div>
            </div>  
