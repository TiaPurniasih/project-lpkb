            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                ...
                <div
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        <div>
                            <span
                                class="text-sm text-gray-500 dark:text-gray-400">Customers</span>
                            <h4
                ...
                <div
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        <div>
                            <span
                                class="text-sm text-gray-500 dark:text-gray-400">Orders</span>
                            <h4
                                class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                                5,359
                            </h4>
            ...
            <div
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-full max-w-8 items-center rounded-full">
                                <img src="src/images/country/country-02.svg"
                                    alt="france" />
                            </div>
                            <div>
                                <p
            ...
            <div
                ...
                <div class="w-full overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <thead>
                            <tr
                                class="border-gray-100 border-y dark:border-gray-800">
                                <th class="py-3">
