...
<head>
    ...
    <title>Muda Dhammasekha - SIOPKB</title>
...
<body class="bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Muda Dhammasekha</h1>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4 pt-4">
                        ...
                        <a href="{{ route('muda-dhammasekha.page2') }}" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                            Lanjutkan
                        </a>
                    </div>
                </div>
