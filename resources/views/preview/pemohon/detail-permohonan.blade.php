...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <!-- Main Content -->
    <main class="max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex-1 self-center w-full">
    ...
    <script>
        function switchTab(tab) {
            ...
            const dokumenBtn = document.getElementById('btn-dokumen');
            ...
            if (tab === 'profil') {
                // Update buttons
                profilBtn.classList.remove('bg-white', 'text-red-600');
                profilBtn.classList.add('bg-red-600', 'text-white');
                dokumenBtn.classList.remove('bg-red-600', 'text-white');
                dokumenBtn.classList.add('bg-white', 'text-red-600');
                riwayatBtn.classList.remove('bg-red-600', 'text-white');
                riwayatBtn.classList.add('bg-white', 'text-red-600');
                
                // Update content visibility
                formalCards.classList.remove('hidden');
                dokumenContent.classList.add('hidden');
                riwayatContent.classList.add('hidden');
            } else if (tab === 'dokumen') {
                // Update buttons
                dokumenBtn.classList.remove('bg-white', 'text-red-600');
                dokumenBtn.classList.add('bg-red-600', 'text-white');
                profilBtn.classList.remove('bg-red-600', 'text-white');
                profilBtn.classList.add('bg-white', 'text-red-600');
                riwayatBtn.classList.remove('bg-red-600', 'text-white');
                riwayatBtn.classList.add('bg-white', 'text-red-600');
                ...
                // Update buttons
                riwayatBtn.classList.remove('bg-white', 'text-red-600');
                riwayatBtn.classList.add('bg-red-600', 'text-white');
                profilBtn.classList.remove('bg-red-600', 'text-white');
                profilBtn.classList.add('bg-white', 'text-red-600');
                dokumenBtn.classList.remove('bg-red-600', 'text-white');
                dokumenBtn.classList.add('bg-white', 'text-red-600');
