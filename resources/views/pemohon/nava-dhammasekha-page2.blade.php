...
<head>
    ...
    <title>Nava Dhammasekha - Dokumen - SIOPKB</title>
...
<body class="bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="flex items-center text-sm text-gray-500">
                ...
                <span class="mx-2">></span>
                <a href="{{ route('nava-dhammasekha') }}" class="hover:text-gray-700">Nava Dhammasekha</a>
                <span class="mx-2">></span>
                <span>Dokumen</span>
            </div>
        </div>
        ...
        <div class="mb-8">
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-6">
                    <!-- SK Pengurus Organisasi (struktur & susunan + KTP) -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            SK Pengurus Organisasi (struktur & susunan + KTP) <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                                   name="sk_pengurus_organisasi" 
                                   id="sk_pengurus_organisasi" 
                                   accept=".pdf,.jpg,.jpeg,.png" 
                                   class="hidden"
                                   onchange="handleFileSelect(this, 'sk_pengurus_organisasi_preview')">
                            <label for="sk_pengurus_organisasi" class="cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-white hover:border-gray-400 transition-colors">
                                    ...
                                    <p id="sk_pengurus_organisasi_preview" class="text-sm text-gray-500 mt-2 hidden"></p>
                                </div>
                            </label>
                        </div>
                    ...
                    <!-- SK Struktur Manajemen & Personalia Penyelenggara Pendidikan -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            SK Struktur Manajemen & Personalia Penyelenggara Pendidikan <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                    ...
                    <!-- Daftar Calon Guru + CV + Ijazah terakhir -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            Daftar Calon Guru + CV + Ijazah terakhir <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                                   name="daftar_calon_guru" 
                                   id="daftar_calon_guru" 
                                   accept=".pdf,.jpg,.jpeg,.png" 
                                   class="hidden"
                                   onchange="handleFileSelect(this, 'daftar_calon_guru_preview')">
                            <label for="daftar_calon_guru" class="cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-white hover:border-gray-400 transition-colors">
                                    <svg class="w-16 h-16 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                                    </svg>
                                    <p class="text-gray-600">Drop files here or click to upload.</p>
                                    <p id="daftar_calon_guru_preview" class="text-sm text-gray-500 mt-2 hidden"></p>
                                </div>
                            </label>
                        </div>
                        <p class="text-sm text-gray-500 mt-2">file (pdf,jpg,png) maks 2 MB</p>
                    ...
                    <!-- Daftar Sarana & Prasarana (detail list) -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            Daftar Sarana & Prasarana (detail list) <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                                   name="daftar_sarana_prasarana" 
                                   id="daftar_sarana_prasarana" 
                                   accept=".pdf,.jpg,.jpeg,.png" 
                                   class="hidden"
                                   onchange="handleFileSelect(this, 'daftar_sarana_prasarana_preview')">
                            <label for="daftar_sarana_prasarana" class="cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-white hover:border-gray-400 transition-colors">
                                    <svg class="w-16 h-16 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                                    </svg>
                                    <p class="text-gray-600">Drop files here or click to upload.</p>
                                    <p id="daftar_sarana_prasarana_preview" class="text-sm text-gray-500 mt-2 hidden"></p>
                                </div>
                            </label>
                        </div>
                        <p class="text-sm text-gray-500 mt-2">file (pdf,jpg,png) maks 2 MB</p>
                    ...
                    <!-- Foto Sarana & Prasarana (ruang kelas, fasilitas, dll) -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            Foto Sarana & Prasarana (ruang kelas, fasilitas, dll) <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                    ...
                    <!-- Sertifikat / surat keterangan kepemilikan/hibah tanah/lahan -->
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">
                            Sertifikat / surat keterangan kepemilikan/hibah tanah/lahan <span class="text-red-600">*</span>
                        </label>
                        <div class="relative">
                            <input type="file" 
                    ...
                    <div class="flex justify-end space-x-4 pt-4">
                        <a href="{{ route('nava-dhammasekha') }}" class="px-6 py-2 border border-red-600 text-red-600 rounded-lg hover:bg-red-50 transition-colors">
                            Kembali
                        </a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const fileInputs = [
                'sk_pengurus_organisasi', 'sk_struktur_manajemen', 'surat_kesanggupan_pembiayaan',
                'dokumen_kurikulum', 'dokumen_rip', 'daftar_calon_guru',
                'sk_kepala_sekolah', 'daftar_tenaga_kependidikan', 'daftar_sarana_prasarana',
                'foto_sarana_prasarana', 'sertifikat_lahan', 'dokumen_studi_kelayakan'
            ];
