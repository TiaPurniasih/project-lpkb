...
<head>
    ...
    <title>Mula Dhammasekha - SIOPKB</title>
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-end space-x-4 pt-4">
                        ...
                        <a href="{{ route('mula-dhammasekha.page2') }}" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                            Lanjutkan
                        </a>
                    </div>
                </div>
